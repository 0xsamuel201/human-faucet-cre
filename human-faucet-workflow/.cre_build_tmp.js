...
function onHttpTrigger(runtime2, payload) {
  ...
  const {
    ...
    verification_level,
    chainId
  } = decodeJson(payload.input);
  runtime2.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  runtime2.log(`Recipient: ${recipient}`);
  runtime2.log(`Nullifier Hash: ${nullifier_hash}`);
  runtime2.log(`Merkle Root: ${merkle_root}`);
  runtime2.log(`Verification level: ${verification_level}`);
  runtime2.log(`Proof: ${proof}`);
  runtime2.log(`Chain ID: ${chainId}`);
  runtime2.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  ...
  const worldcoinResponse = httpClient.sendRequest(runtime2, {
  ...
  runtime2.log("World ID proof verified successfully via API!");
  let network248 = null;
  if (chainId === 11155111) {
    network248 = getNetwork({
      chainFamily: "evm",
  ...
  const contractAddress = chainId === 11155111 ? config.sepoliaContractAddress : config.arbSepoliaContractAddress;
  runtime2.log(`Target chain: ${network248.chainSelector.name}`);
  runtime2.log(`Contract address: ${contractAddress}`);
  const evmClient = new cre.capabilities.EVMClient(network248.chainSelector.selector);
  const reportData = encodeAbiParameters(parseAbiParameters("address recipient, uint256 nullifierHash"), [recipient, BigInt(nullifier_hash)]);
